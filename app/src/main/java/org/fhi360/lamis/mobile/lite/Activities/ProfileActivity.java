...
public class ProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        HashMap<String, String> patientId1 = session.getPatientId();
...
//        else  if(id==R.id.editIndex){
//            Intent intent2 = new Intent(getApplicationContext(), EditIndex.class);
//            startActivity(intent2);
//        }
//        else  if(id==R.id.editSexualContact){
//            Intent intent2 = new Intent(getApplicationContext(), EditIndexSexualContact.class);
//            startActivity(intent2);
//        }
