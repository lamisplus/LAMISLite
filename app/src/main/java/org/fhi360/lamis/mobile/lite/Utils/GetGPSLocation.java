...
/**
 * Created by idris on 10-08-2019.
 */
public class GetGPSLocation implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LocationListener {
    ...
    public GetGPSLocation(Activity activity) {
        context = activity;
    ...
    protected void createLocationRequest() {
        //check if the is change in the interval of time
    ...
    public void getCurrentLocation() {
        ...
        if (checkPermission()) {
            ...
            if (mLastLocation == null) {
                ...
                Log.v("oyisco:::: ", latitude);
                Log.v("akor::: ", longitude);
                //PrefManager prefManager = new PrefManager(context);
               // prefManager.createCoordinate(longitude, latitude);
